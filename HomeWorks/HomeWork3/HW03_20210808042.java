...
public class HW03_20210808042 {
    public static void main(String[] args) {
        Author author = new Author("Müslüm", "Agah", "mslmagh@gmail.com");
        PaperBook paperBook = new PaperBook("ff", "Mat", author, true);
        System.out.println(paperBook.getShippingWeight());
        Book a = new Book("d", "c", author);
...
class PaperBook extends Book {
    ...
    public PaperBook(String isbn, String title, Author author, boolean inStock) {
        super(isbn, title, author);
        this.inStock = inStock;
        this.shippingWeight = (int) ((Math.random() * 10) + 6);
    }
