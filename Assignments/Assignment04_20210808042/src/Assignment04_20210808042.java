...
public class Assignment04_20210808042 {
...
class Student extends Person {
    ...
    for (CourseGrade gradee : courseGrades) {
        if (gradee.getCourse().equals(course) && gradee.getCourse().getSemester().equals(semester)) {
            gradee.setGrade(newGrade.getGrade());
            courseTaken = true;
            break;
        }
    }
